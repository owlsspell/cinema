      ...
      <div className={s.nav}>
        ...
        <div className={s.navBody}>
          <Tabs orientation="vertical" value={value} onChange={handleChange}>
            <Tab
              className={0 == activeTab ? s.tabs + " " + s.active : s.tabs}
              onClick={() => toogleTab(0)}
              label={
            ...
            />
            <Tab
              className={1 == activeTab ? s.tabs + " " + s.active : s.tabs}
              onClick={() => toogleTab(1)}
              label={
                <Link className={s.links} to="/cinema">
                  Cinema
                </Link>
              }
            />
            <Tab
              className={2 == activeTab ? s.tabs + " " + s.active : s.tabs}
              onClick={() => toogleTab(2)}
              label={
                <Link className={s.links} to="/users">
                  Users
                </Link>
              }
            />
            {/* <Tab
              className={3 == activeTab ? s.tabs + " " + s.active : s.tabs}
              onClick={() => toogleTab(3)}
              label={
